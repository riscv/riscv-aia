...
\z{0x35D} & MRW & \z{mtopei}   & Machine top external interrupt \\
\hline
...
\z{0x15D} & SRW & \z{stopei}   & Supervisor top external interrupt \\
\hline
\multicolumn{4}{|c|}{%
...
\z{0x25D} & SRW & \z{vstopei}    & Virtual supervisor top external interrupt \\
\hline
