...
\z{mclreienum}, and \z{mclaimei}, interact with an IMSIC, so exist only
...
\z{sclreienum}, and \z{sclaimei}, are described with the IMSIC in
...
\z{vsseteienum}, or \z{vsclreienum} raise an illegal instruction
exception, and attempts from \mbox{VS-mode} to access \z{sseteipnum},
\z{sclreipnum}, \z{sseteienum}, \z{sclreienum}, or \z{sclaimei} raise a
virtual instruction exception.

Aside from the high-half CSR \z{hidelegh}, the hypervisor CSRs added
by the Advanced Interrupt Architecture (\z{hvien}, \z{hvicontrol},
