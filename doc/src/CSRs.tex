...
\hline
\z{0x350} & MRW & MXLEN & \z{miselect} & Machine indirect register select \\
\z{0x351} & MRW & MXLEN & \z{mireg}    & Machine indirect register alias \\
\hline
...
\hline
\z{0x150} & SRW & SXLEN & \z{siselect} & Supervisor indirect register select \\
\z{0x151} & SRW & SXLEN & \z{sireg}    & Supervisor indirect register alias \\
\hline
...
\hline
\z{0x250} & HRW & VSXLEN & \z{vsiselect}
                               & Virtual supervisor indirect register select \\
\z{0x251} & HRW & VSXLEN & \z{vsireg}
...
Similarly, when \z{vsiselect} has a reserved value,
...
\mbox{VS-mode} or \mbox{VU-mode} to access \z{sireg} (really \z{vsireg})
...
values of \z{vsiselect} are either reserved
