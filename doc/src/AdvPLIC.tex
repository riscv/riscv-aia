...
simply as read-only with values zero and \z{8x00000000}, and a
...
If bit~L in \z{smsiaddrcfgh} is set to one, \z{smsiaddrcfg} and
...
\z{smsiaddrcfgh} have only read-only values zero and \z{0x80000000}
respectively.
Any time \z{smsiaddrcfg} or \z{smsiaddrcfgh} has a different value
(not zero or \z{0x80000000} respectively), the addresses for outgoing
