...
xref:IMSIC.adoc#MSIEncoding[].) This data may be in
...
memory-mapped register `seteipnum_le` (xref:IMSIC.adoc#IMSIC-memRegion[]). IMSIC interrupt
...
(xref:IMSIC.adoc#IMSIC-memRegion[]), then an IOMMU
