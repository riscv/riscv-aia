...
xref:intro.adoc#intrsWithoutIMSICs[Figure 1. Traditional delivery of wired interrupts to harts without support for MSIs.]). A
...
(Recall xref:intro.adoc#intrsWithIMSICs[Figure 2. Interrupt delivery by MSIs when harts have IMSICs for receiving them].)
...
to zero. See xref:IMSIC.adoc#IMSIC-reg-eidelivery[External interrupt delivery enable register (`eidelivery`)]
...
(See xref:IMSIC.adoc#IMSIC-systemMemRegions[Arrangement of the memory regions of multiple interrupt files].)
...
(xref:IMSIC.adoc#IMSIC-intrFilesAndIdents[Interrupt files and interrupt identities]),
...
interrupt files are set to `0x40000000` (xref:IMSIC.adoc#IMSIC-reg-eidelivery[External interrupt delivery enable register (`eidelivery`)]). For a
...
Assuming the recommendations of xref:IMSIC.adoc#IMSIC-systemMemRegions[Arrangement of the memory regions of multiple interrupt files] are
...
xref:IMSIC.adoc#IMSIC-systemMemRegions[Arrangement of the memory regions of multiple interrupt files], HHXW = latexmath:[j], LHXW = latexmath:[k], HHXS = latexmath:[{E-24}], LHXS = latexmath:[{C-12}], and Base PPN = latexmath:[A]>>12.
...
xref:IMSIC.adoc#IMSIC-systemMemRegions[Arrangement of the memory regions of multiple interrupt files], HHXW = latexmath:[j], LHXW = latexmath:[k], HHXS = latexmath:[{E-24}], LHXS = latexmath:[{D-12}], and Base PPN = latexmath:[B]>>12.
